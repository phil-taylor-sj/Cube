...
namespace CollisionChecks_Tests
{
        ...
        Two_circle_arguments_which_do_not_intersect_should_return_false)
    {
        ...
        EXPECT_FALSE(phys::checkIntersection(circleBase, circleOne));
        EXPECT_FALSE(phys::checkIntersection(circleBase, circleTwo));
        EXPECT_FALSE(phys::checkIntersection(circleBase, circleThree));

        EXPECT_FALSE(
            phys::checkIntersection(
                phys::Circle(-225.5, -300., 100.),
                phys::Circle(-370., -360., 50.)
            )
        );
    }
    ...
    )
    {
        ...
        EXPECT_TRUE(phys::checkIntersection(circleBase, circleOne));
        EXPECT_TRUE(phys::checkIntersection(circleBase, circleTwo));

        EXPECT_TRUE(
            phys::checkIntersection(
                phys::Circle(-225.5, -300., 100.),
                phys::Circle(-365., -300., 50.)
            )
        );
    }
    ...
    )
    {
        ...
        EXPECT_FALSE(phys::checkIntersection(rectangleBase, rectangleOne));
        EXPECT_FALSE(phys::checkIntersection(rectangleOne, rectangleBase));

        EXPECT_FALSE(phys::checkIntersection(rectangleBase, rectangleTwo));
        EXPECT_FALSE(phys::checkIntersection(rectangleTwo, rectangleBase));

        EXPECT_FALSE(phys::checkIntersection(rectangleBase, rectangleThree));
        EXPECT_FALSE(phys::checkIntersection(rectangleThree, rectangleBase));

        EXPECT_FALSE(
            phys::checkIntersection(
                phys::Rectangle(-350., -350., 300., 100.),
                phys::Rectangle(-350., -500., 400., 100.)
            )
        );
    }
    ...
    )
    {
        ...
        EXPECT_TRUE(phys::checkIntersection(rectangleBase, rectangleOne));
        EXPECT_TRUE(phys::checkIntersection(rectangleOne, rectangleBase));

        EXPECT_TRUE(phys::checkIntersection(rectangleBase, rectangleTwo));
        EXPECT_TRUE(phys::checkIntersection(rectangleTwo, rectangleBase));

        EXPECT_TRUE(phys::checkIntersection(rectangleBase, rectangleThree));
        EXPECT_TRUE(phys::checkIntersection(rectangleThree, rectangleBase));

        EXPECT_TRUE(phys::checkIntersection(rectangleBase, rectangleFour));
        EXPECT_TRUE(phys::checkIntersection(rectangleFour, rectangleBase));

        EXPECT_TRUE(phys::checkIntersection(rectangleBase, rectangleFive));
        EXPECT_TRUE(phys::checkIntersection(rectangleFive, rectangleBase));

        EXPECT_TRUE(phys::checkIntersection(rectangleBase, rectangleSix));
        EXPECT_TRUE(phys::checkIntersection(rectangleSix, rectangleBase));

        EXPECT_TRUE(
            phys::checkIntersection(
                phys::Rectangle(-350., -350., 300., 100.),
                phys::Rectangle(-550., -450., 110., 110.)
            )
        );
    }
    ...
    )
    {
        ...
        EXPECT_TRUE(
            phys::checkIntersection(
                phys::Rectangle(-350., -350., 300., 100.),
                phys::Rectangle(-300., -340., 400., 200.)
            )
        );
    }
    ...
    )
    {
        ...
        EXPECT_FALSE(phys::checkIntersection(rectangleTwo, rectangleThree));
        EXPECT_FALSE(phys::checkIntersection(rectangleThree, rectangleTwo));
    }
    ...
    )
    {
        ...
        EXPECT_TRUE(phys::checkIntersection(rectangleTwo, rectangleThree));
        EXPECT_TRUE(phys::checkIntersection(rectangleThree, rectangleTwo));
    }
    ...
    )
    {
        ...
        EXPECT_FALSE(phys::checkIntersection(rectangleThree, rectangleFour));
        EXPECT_FALSE(phys::checkIntersection(rectangleFour, rectangleThree));
    }
    ...
    )
    {
        ...
        EXPECT_TRUE(phys::checkIntersection(rectangleThree, rectangleFour));
        EXPECT_TRUE(phys::checkIntersection(rectangleFour, rectangleThree));
    }
    ...
    )
    {
        ...
        EXPECT_FALSE(phys::checkIntersection(rectangleBase, circleOne));
        EXPECT_FALSE(phys::checkIntersection(rectangleBase, circleTwo));
        EXPECT_FALSE(phys::checkIntersection(rectangleBase, circleThree));
        EXPECT_FALSE(phys::checkIntersection(rectangleBase, circleFour));
        ...
        EXPECT_FALSE(phys::checkIntersection(rectangleOne, circleFive));
        EXPECT_FALSE(phys::checkIntersection(rectangleOne, circleSix));
    }
    ...
    )
    {
        ...
        EXPECT_TRUE(phys::checkIntersection(rectangleBase, circleOne));
        EXPECT_TRUE(phys::checkIntersection(rectangleBase, circleTwo));
        EXPECT_TRUE(phys::checkIntersection(rectangleBase, circleThree));
        EXPECT_TRUE(phys::checkIntersection(rectangleBase, circleFour));
        EXPECT_TRUE(phys::checkIntersection(rectangleBase, circleFive));
        EXPECT_TRUE(phys::checkIntersection(rectangleBase, circleSix));

        phys::Rectangle rectangleOne = phys::Rectangle(-750.f, -675.f, 500.f, 150.f);
        phys::Circle circleSeven = phys::Circle(-480.f, -580.f, 50.f);
        phys::Circle circleEight = phys::Circle(-1030.f, -770.f, 50.f);

        EXPECT_TRUE(phys::checkIntersection(rectangleOne, circleSeven));
        EXPECT_TRUE(phys::checkIntersection(rectangleOne, circleEight));
